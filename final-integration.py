...
frame_thresh_1 = 15
frame_thresh_2 = 10
frame_thresh_3 = 5  #frame_thresh_3 is the threshold value after yawn detection threshold value of our frame i.e our head posture 

close_thresh = 0.3#(close_avg+open_avg)/2.0 
flag = 0
yawn_countdown = 0 # flag for yawn 
map_counter = 0
map_flag = 1
count_check = 0
# print(close_thresh)
    ...
    if(len(rects)):
        ...
        if(avgEAR<close_thresh):
            ...
            if(yawn_countdown and flag>=frame_thresh_3):
                ...
                count_check+=1
                #print("threshold_3"+ str(count_check))
                alert.play()
                if(map_flag):
                    map_flag = 0
                    map_counter+=1
